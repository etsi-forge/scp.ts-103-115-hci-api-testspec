 ...
 */
public class Api_2_CEl_Ocb_8 extends Applet implements CardEmulationListener {
	...
	private Api_2_CEl_Ocb_8() {
		...
		sentOnce = 0x00;
		ibuffer = JCSystem.makeTransientByteArray((short) 2, JCSystem.CLEAR_ON_DESELECT);
	}
	...
	public void process(APDU apdu) throws ISOException {
		...
		case INS_EVENT_DEACTIVATE_VERIFY:
			...
			if ((verificationByte & 0x08) == 0x08)
				ISOException.throwIt((short) (ISO7816.SW_NO_ERROR + (short)1));
