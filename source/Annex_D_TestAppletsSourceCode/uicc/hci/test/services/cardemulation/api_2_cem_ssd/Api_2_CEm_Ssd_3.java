 ...
 *</code>
 */
public class Api_2_CEm_Ssd_3 extends Applet implements CardEmulationListener {
	...
	public void onCallback(byte event, HCIMessage hcimessage) {
        ...
        case EVENT_ON_SEND_DATA:
			...
			try {
				message.prepareAndSendSendDataEvent(ibuffer, (short)15, (short)5);
