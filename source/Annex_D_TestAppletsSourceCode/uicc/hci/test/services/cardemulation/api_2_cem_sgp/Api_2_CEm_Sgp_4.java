 ...
 */
public class Api_2_CEm_Sgp_4 extends Applet implements CardEmulationListener {
	...
	public void onCallback(byte event, HCIMessage hcimessage) {
		...
		case EVENT_ON_SEND_DATA:
			...
			try {
				message.prepareAndSendGetParameterCommand(CardEmulationMessage.PARAM_ID_TYPE_A_CARD_CLT_SUPPORT);
			} catch (HCIException e) {
