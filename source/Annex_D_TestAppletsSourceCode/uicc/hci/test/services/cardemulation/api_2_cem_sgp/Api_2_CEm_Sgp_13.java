 ...
 */
public class Api_2_CEm_Sgp_13 extends Applet implements CardEmulationListener {
	...
	public void onCallback(byte event, HCIMessage hcimessage) {
		...
		case EVENT_ON_SEND_DATA:
			...
			try {
				message.prepareAndSendGetParameterCommand(CardEmulationMessage.PARAM_ID_TYPE_B_CARD_MODE);
			} catch (HCIException e) {
