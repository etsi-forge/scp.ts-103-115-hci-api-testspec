 ...
 */
public class Api_2_CEm_Sgp_12 extends Applet implements CardEmulationListener {
	...
	private Api_2_CEm_Sgp_12() {
		...
		exceptions = JCSystem.makeTransientByteArray((short) 1, JCSystem.CLEAR_ON_RESET);
	}
	...
	public void onCallback(byte event, HCIMessage hcimessage) {
		...
		case EVENT_ON_SEND_DATA:
			...
			try {
				message.prepareAndSendGetParameterCommand(CardEmulationMessage.PARAM_ID_TYPE_B_CARD_HIGHER_LAYER_RESPONSE);
			} catch (HCIException e) {
