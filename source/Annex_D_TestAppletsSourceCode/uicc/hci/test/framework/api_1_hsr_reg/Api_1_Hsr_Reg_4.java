 ...
 */
public class Api_1_Hsr_Reg_4 extends Applet implements ConnectivityListener {
	...
	private ConnectivityService ceService;

	private Api_1_Hsr_Reg_4() {
		register();
	}
	...
	public void process(APDU apdu) throws ISOException {
		...
		case INS_REGISTER_ALREADY_REGISTERED:
			try {
				ceService = (ConnectivityService) HCIDevice.getHCIService(HCIDevice.CONNECTIVITY_SERVICE_ID);
