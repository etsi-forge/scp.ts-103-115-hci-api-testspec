 ...
 */
public class Api_1_Hdv_Isa_1 extends Applet implements CardEmulationListener {
	...
	private final static short INS_CNN_SERVICE_AVAILABLE = (short) 0x07;
	private final static short INS_RS_SERVICE_AVAILABLE = (short) 0x08;
	
	
	private Api_1_Hdv_Isa_1() {		
	...
	public void process(APDU apdu) throws ISOException {
	    ...
	    switch (buffer[ISO7816.OFFSET_INS]) {
	      ...
	      case INS_CEM_SERVICE_AVAILABLE:
	    	  ...
	    	  break;
	      case INS_CNN_SERVICE_AVAILABLE:
	    	  buffer[2] = HCIDevice.isHCIServiceAvailable(HCIDevice.CONNECTIVITY_SERVICE_ID);	    	  
	    	  break;
		  case INS_RS_SERVICE_AVAILABLE:
			  buffer[2] = HCIDevice.isHCIServiceAvailable(HCIDevice.READER_SERVICE_ID);	    	  
			  break;
	      default: 
