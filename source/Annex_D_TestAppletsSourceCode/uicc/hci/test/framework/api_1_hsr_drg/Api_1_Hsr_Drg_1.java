 ...
 */
public class Api_1_Hsr_Drg_1 extends Applet implements CardEmulationListener {
	...
	private static final byte INS_DEREGISTER_CEM_SERVCE = (byte) 0x01;

	private static final byte INS_DEREGISTER_CNN_SERVCE = (byte) 0x02;
	...
	public void process(APDU apdu) throws ISOException {
		...
		case INS_DEREGISTER_CEM_SERVCE:
			try {
		...
		case INS_DEREGISTER_CNN_SERVCE:
			try {
