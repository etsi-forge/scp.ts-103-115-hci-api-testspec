package uicc.hci.test.framework.api_1_hme_mhd;
 ...
 * <code>boolean isHeading()</code>
 */
public class Api_1_Hme_Mhd_1 extends Applet implements CardEmulationListener {
	...
	private Api_1_Hme_Mhd_1() {
		...
		try {
			...
			ISOException.throwIt(ISO7816.SW_DATA_INVALID); //may be defined more precise
		}	
